...
public class Offer {
    ...
    // setInfo GENERATE ====>  Right Click ==> Generate ==> ==> Constructor ==> Select all instance ==> OK

    // public Offer ===> public void setInfo
    ...
    // toString() GENERATE ====>  Right Click ==> Generate ==> ==> toString ==> Select all Attributes ==> Uncheck "Insert@override" ==> OK
