...
public class RelationalOperators {
    ...
    public static void main(String[] args) {
        ...
        boolean isEligibleForLoan = creditScore >= creditlimit; // if the credit score is 720 or greater, then it's eligible for the loan
        ...
        int score = 75;
        boolean hasFailed =  score <= 59; // false               //   75 <= 59
