...
Write a class Car that extends the Animal class.
...
if the dog's age is less or equals to 2, multiple age by 11; otherwise, human years is equals to:
22 + ((age-2) * 5);

Override the equals() method for the Car class that returns true if the dog’s name, age,
