package replitSolutions;//Declare 9 String variables firstName, lastName, fullName, email, street, state, city, address, contacts.
//
...
//        Full name: May, James
//        Car: 7925 Jones Branch Dr, McLean, VA 22102
...
public class _1_007_Variables_PatientInformation {
    public static void main(String[] args) {
        ...
        System.out.println("Car: "+ street + ", " + city + ", " + state + " " + zipcode);
