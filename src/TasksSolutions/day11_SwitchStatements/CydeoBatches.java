package TasksSolutions.day11_SwitchStatements;
...
public class CydeoBatches {
    ...
    public static void main(String[] args) {
        ...
        switch (batchType){
            case "US morning":
                result = "Tester times are 10-5 EST. M, T, Th, F.";
                break;

            case "US evening":
                result = "Tester times are 7-10 EST. M, T, W, Th, S, S.";
                break;

            case "EU":
                result = "Tester times are  10-5 EST. M, T, W, Th, F.";
                break;
